...
const std::map<TEXTURE_ASSET_ID, vec2 > ASSET_SIZE = {
        ...
        { TEXTURE_ASSET_ID::FOLLOWING_ENEMY, {11 * CHARACTER_SCALING, 11 * CHARACTER_SCALING}},
...
const std::map<TEXTURE_ASSET_ID, vec2 > SPRITE_SCALE = {
        ...
        { TEXTURE_ASSET_ID::FOLLOWING_ENEMY, {20 * CHARACTER_SCALING, 20 * CHARACTER_SCALING}},
...
const std::map<TEXTURE_ASSET_ID, vec2 > SPRITE_OFFSET = {
        ...
        { TEXTURE_ASSET_ID::FOLLOWING_ENEMY, {0, 3 * CHARACTER_SCALING}},
