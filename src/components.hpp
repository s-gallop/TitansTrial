...
enum class TEXTURE_ASSET_ID
{
	...
	BATTLE_BUTTON = HELPER + 1,
	BATTLE_BUTTON_PRESSED = BATTLE_BUTTON + 1,
	HELP_BUTTON = BATTLE_BUTTON_PRESSED + 1,
	HELP_BUTTON_PRESSED = HELP_BUTTON + 1,
	QUIT_BUTTON = HELP_BUTTON_PRESSED + 1,
	QUIT_BUTTON_PRESSED = QUIT_BUTTON + 1,
	TITLE_TEXT = QUIT_BUTTON_PRESSED + 1,
